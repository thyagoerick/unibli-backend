...
git config --list -- conferir se esta remote.origin.url=https://github.com/wesbarros/unibli-backend.git
    ...
    Depois de fazer as alterações na branch certa
Faz o commit das alterações
git checkout main -- mudar para a main
git pull -- para ter certeza que não tem mais arquivo (already up to date)
git merge weslley -- traz as atualizações que fiz para a main
git push
*/